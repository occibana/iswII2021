...
namespace LogicaNC
{
    public class LMembresias
    {
        ...
        public LMembresias(Mapeo context)
        {
            _context = context;
        }
        ...
        public UMembresias pageLoad(URegistro session)
        {
            ...
            if (session.Idestado == 1) //1 Es con menbresia, 0 sin membresia
            {
                ...
                UMembresia fechavencimiento = new DAOSeguridad(_context).fechavencimiento(usuario);
        ...
        public async Task<UMembresias> comprar(UMembresia datoscompra, URegistro usuario, URegistro session)
        {
            ...
            {
                var verificacion = await new DAOLogin(_context).verificarLogincompra(usuario);
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        new DAOSeguridad(_context).insertarCompra(datoscompra);
                        ...
                        new DAOSeguridad(_context).actualizarmembresia(usuario);
